...
function CartNavbar() {
  ...
  return (
    <nav className={`navbar navbar-expand-lg fixed-top ${sticky ? 'sticky' : ''}`} style={{ backgroundColor: '#e9f7ef' }}>
      <div className="container">
        <a id="logo" className="navbar-brand me-auto" href="#">
          <FaCartArrowDown />
          Shoping Cart
        </a>
        ...
        <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div className="offcanvas-body">
            <ul className="navbar-nav justify-content-center flex-grow-1 pe-3">
              ...
              <li className="nav-item">
                <a id="nav-links" className="nav-link mx-lg-2 active" href="/sampleSeed">Shopping</a>
              </li>
            </ul>
          </div>
        </div>
